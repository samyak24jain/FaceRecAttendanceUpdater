...
class Main:
    ...
    def recognizeFaces(self):
        try:
            ...
            path = "/home/samyak/POP Project/database/Basedatabase"
            ...
            for imgname in image_paths:
                ...
                dirname = "/home/samyak/POP project/database/newDB"
                eigenfaces = 22
                threshold = 0.6
    ...
    def image_capture(self):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite("/home/samyak/POP project/database/input/cropped_{1}_{0}.png".format(str(y), str(x)), image)
